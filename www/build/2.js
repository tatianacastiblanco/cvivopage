...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__chat__ = __webpack_require__(885);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_ngx_embed_video__ = __webpack_require__(890);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__chat_chat_module__ = __webpack_require__(731);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_ionic_image_loader__ = __webpack_require__(400);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__chat_chat__ = __webpack_require__(885);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_components_module__ = __webpack_require__(753);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_angularfire2_firestore__ = __webpack_require__(74);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_angularfire2_firestore___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_angularfire2_firestore__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_add_operator_map__ = __webpack_require__(886);
...
var embed_video_service_1 = __webpack_require__(891);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__data_Helper__ = __webpack_require__(884);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__data_HomeScreenGroupItem__ = __webpack_require__(756);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__data_HomeScreenGroup__ = __webpack_require__(408);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_ngx_embed_video__ = __webpack_require__(890);
...
var HomePage = /** @class */ (function () {
    //slides: any;
    function HomePage(navCtrl, platform, alertCtrl, db, embedService, chatService, toastCtrl, VimeoService, events, modalCtrl, navParams, authService) {
        var _this = this;
        this.navCtrl = navCtrl;
        ...
        this.db.collection('Config').doc(sessionStorage.getItem('channelName')).valueChanges().subscribe(function (res) {
            _this.event = res['chatEvent'];
            _this.chatEnable = res['Vivo'];
    ...
    HomePage.prototype.gethomeVideo = function () {
        ...
        var promise = new Promise(function (resolve, reject) {
            _this.db.collection('Config').doc(_this.channelName).valueChanges().subscribe(function (res) {
                _this.iframe_html = _this.embedService.embed_vimeo(res['Idvivo'], {
    ...
    HomePage.prototype.getHomeGroups = function () {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
            var collection = JSON.parse(sessionStorage.getItem('categories'));
    ...
    ;
    HomePage.prototype.goToChannels = function () {
        this.navCtrl.setRoot('ChannelsPage');
    };
    // ||||||||||||||||||||||||||||||||||||||||||||||||||||------------------------||||||||||||||||||||||||||||||||||||||||||                 
    // ||||||||||||||||||||||||||||||||||||||||||||||||||||        Helpers         ||||||||||||||||||||||||||||||||||||||||||
    ...
    ;
    HomePage.prototype.canales = function () {
        this.navCtrl.setRoot('ChannelsPage');
    };
    __decorate([
    ...
    HomePage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_5_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3_angularfire2_firestore__["AngularFirestore"],
            __WEBPACK_IMPORTED_MODULE_9_ngx_embed_video__["EmbedVideoService"],
            __WEBPACK_IMPORTED_MODULE_2__services_ChatService__["a" /* ChatService */],
